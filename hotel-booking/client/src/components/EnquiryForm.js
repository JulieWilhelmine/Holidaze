...
export default class EnquiryForm extends Component {
	...
	render() {
		return (
			<form onSubmit={this.sendEnquiry} className="[ makeEnquiry__form ]">
				<fieldset>
					...
					<input
						...
						name="establishment"
						id="establishment"
						className="[ makeEnquiry__input ] [ makeEnquiry__input--establishment ]"
				...
				<fieldset>
					...
					<input
						...
						name="checkin"
						id="checkin"
						className="[ makeEnquiry__input ] [ makeEnquiry__input--dates ]"
				...
				<fieldset>
					...
					<input
						...
						placeholder="adults"
						min="1"
						className="[ makeEnquiry__input ] [ makeEnquiry__input--guests ]"
				...
				<fieldset>
					...
					<input
						...
						name="notes"
						id="notes"
						className="[ makeEnquiry__input ] [ makeEnquiry__input--notes ]"
