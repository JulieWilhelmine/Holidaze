		...
		return (
			<div className="[ container-fluid ]">
				<div className="[ col-sm-12 ] [ hotel ]">
					<AccommodationSpecific name={establishmentName} image={imageUrl} description={description} email={establishmentEmail} price={price} lat={googleLat} long={googleLong} max={maxGuests} openModal={this.openModal} />
				</div>

				<Modal className="[ enquiryModal ]" show={this.state.modalIsOpen} onRequestClose={this.closeModal} dialogClassName="modal-90w" aria-labelledby="example-custom-modal-styling-title" size="lg">
